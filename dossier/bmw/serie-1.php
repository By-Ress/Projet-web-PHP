...
<section aria-label="serie1-slide-foto">

    <div class="slide">
        <img src="../../image/BMW/bmw-serie-1-1.jpeg" alt="serie 1 #1" class="image__slider active">
        <img src="../../image/BMW/bmw-serie-1-2.jpeg" alt="serie 2 #2" class="image__slider">
        <img src="../../image/BMW/bmw-serie-1-3.jpeg" alt="serie 3 #3" class="image__slider">
        <div class="precedent">
